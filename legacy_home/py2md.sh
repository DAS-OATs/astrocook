#python py2md.py General equalize,combine,mask,telluric_mask,snr_est,resol_est,rms_est,rebin,gauss_convolve,flux_ccf,flux_ccf_stats > docs/general_cb.md
#pythonw py2md.py Edit import_systs,import_telluric,mask
...
pythonw py2md.py Continuum clip_flux
...
#pythonw py2md.py Absorbers find_lines,model_metals
