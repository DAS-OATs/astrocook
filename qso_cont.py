...
def main():
    ...
    try: 
        ...
        spec_em.rem_lines(list_em, mode='em', col='abs_rem', size=medium, 
                          timer=0.1)
    ...
    try:
        ...
        # The continuum is extracted by taking the em_fit profile where the 
        # emission lines are and filtering the abs_rem profile elsewhere
    ...
    try:
        ...
        print(" Fitting and removing absorption lines...")
        spec_cont.fit_lines(list_cont, timer=timer)
        #spec_cont.fit_lines_2(list_cont, zem=zem, timer=timer)
    ...
    plt.plot(spec_abs.x, spec_abs.abs_rem, c='red') #red
    plt.plot(spec_cont.x, spec_cont.abs_fit, c='green') #green 
    plt.plot(spec_cont.x, spec_cont.abs_rem, c='cyan') #cyan
    plt.xlim(402.8, 403.1)
    plt.show()
    """
