...
<span style="color:#f5a100"><b>Version: {{ version }}</b></span>
...
Partly funded by the PRIN PNRR project “Next generation computing & data technologies to probe the cosmic metal content”.
